...
@app.route('/actors')
def actors():
    actors = queries.get_20_actors_sorted_by_first_name()
...
# def detailed_view(show_id, show_detail=None):
#     show_details=queries.get_show(id)
#     actors=queries.get_show_characters(show_id)
#     return render_template('detailed-view.html', show_details=show_detail,actors)
